...
public abstract class Connection extends SmppObject {
     ...
     *
     * @throws java.io.IOException Opening the connection can cause
     ...
     *
     * @throws java.io.IOException Closing the connection can cause
     *                             IOException in the derived classes.
     */
     ...
     * @throws java.io.IOException Sending a data over connection
     ...
     * @throws java.io.IOException Receiving data over connection
     *                             can cause IOException in the derived classes.
     */
     ...
     * @throws java.io.IOException waiting for connection can cause
     *                             an IOException
     */
